...
public class MyTunes 
{
	...
	// DONE: Define the class Jukebox such that it manages three objects of type Queue<SongEntry>
	//       where a Queue object represents a playlist. Possible valid playlists are "favorites",
	//       "lounge" and "road trip", called favoritesPL, loungePL and roadTripPL respectively.
	 ...
	 */
	public MyTunes(String requestedFile, SongEntry[] allSongs)
	{
		// DONE: Define the constructor of class Jukebox such that initializes the playlists.
		jukebox = new Jukebox();

		// DONE: Define the class Jukebox fillPlaylists() method such that it reads the test file
	...
	public static void main(String[] args) 
	{
		...
		// DONE: Tests Jukeboxs class by enqueu-ing songs in the different playlists.
		...
		if(numberOfSongsToPlay > totalSongsToPlay){
			numberOfSongsToPlay = totalSongsToPlay;
		}
		if(numberOfSongsToPlay <= 0){
			System.out.println("You chose not to play a song. Exiting the program.");
			System.exit(0);
		}
